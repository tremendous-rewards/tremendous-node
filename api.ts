...
export const CreateInvoiceRequestCurrencyCodeEnum = {
    Usd: 'USD',
    Eur: 'EUR',
    Gbp: 'GBP',
    Cad: 'CAD'
...
export const FraudReviewReasonsEnum = {
    ...
    DeviceOnATremendousFraudList: 'Device on a Tremendous fraud list',
...
export const ListProductsResponseProductsInnerSkusInnerCurrencyCodeEnum = {
    Usd: 'USD',
    Cad: 'CAD',
    Eur: 'EUR',
    Aed: 'AED',
...
export const MembersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateMember: async (id: string, updateMemberRequest: UpdateMemberRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const MembersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updateMember(id: string, updateMemberRequest: UpdateMemberRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateMember200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateMember(id, updateMemberRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ProductsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [id] Comma-separated list of product IDs, used to only retrieve the provided products. Also accepts the special value &#x60;ALL_FEE_FREE&#x60;, which stands for every product in your catalog that carries no fee.
         ...
         * @throws {RequiredError}
         */
        listProducts: async (id?: string, country?: string, currency?: string, subcategory?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ProductsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listProducts(id?: string, country?: string, currency?: string, subcategory?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListProductsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listProducts(id, country, currency, subcategory, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ProductsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listProducts(id?: string, country?: string, currency?: string, subcategory?: string, options?: RawAxiosRequestConfig): AxiosPromise<ListProductsResponse> {
            return localVarFp.listProducts(id, country, currency, subcategory, options).then((request) => request(axios, basePath));
        },
    };
};
